...
This template export is intended for Zabbix 7.0 and is stored under the
...
Future exports for other major Zabbix versions should be kept in their own
version directories, such as `templates/zabbix-8.0/`.
...
3. Click `Import`.
4. Select `templates/zabbix-7.0/advanced-icmp-ping-with-jitter.yaml`.
